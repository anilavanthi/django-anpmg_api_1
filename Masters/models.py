...
class Customer(models.Model):
    ...
    birthtime = models.CharField(max_length=15, null=True, blank=True)
    ...
    eindiaworkingsince= models.CharField(max_length=20, null=True, blank=True)
    ...
    eabroadvalidfrom= models.CharField(max_length=20, null=True, blank=True)
    eabroadvalidto= models.CharField(max_length=20, null=True, blank=True)
    ...
    leducation = models.CharField(max_length=30, null=True, blank=True)
